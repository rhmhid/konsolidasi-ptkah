...
Route::group('api/migrasi-data', ['middleware' => 'AuthMiddleware'], function ()
{
    ...
    Route::get('/import-barang/list-kategori', 'API/Konfigurasi/MigrasiDataAPI@list_data_kategori')->name('api.migrasi_data.import_barang.list_kategori');
    Route::get('/import-barang/list-satuan', 'API/Konfigurasi/MigrasiDataAPI@list_data_satuan')->name('api.migrasi_data.import_barang.list_satuan');
    Route::get('/import-barang/download-file', 'API/Konfigurasi/MigrasiDataAPI@download_file_barang')->name('api.migrasi_data.akunting.import_barang.download');
    Route::patch('/import-barang/save', 'API/Konfigurasi/MigrasiDataAPI@save_import_barang')->name('api.migrasi_data.import_barang.save');
    Route::patch('/import-stok/save', 'API/Konfigurasi/MigrasiDataAPI@save_import_stok')->name('api.migrasi_data.import_stok.save');
});
...
Route::group('api/migrasi-data/akunting', ['middleware' => 'AuthMiddleware'], function ()
{
    ...
    // Serba Import Manual AP
    Route::get('/import-manual-ap/download-file', 'API/Konfigurasi/MigrasiDataAPI@download_file_manual_ap')->name('api.migrasi_data.akunting.import_manual_ap.download');
    Route::patch('/import-manual-ap/save', 'API/Konfigurasi/MigrasiDataAPI@save_import_manual_ap')->name('api.migrasi_data.akunting.import_manual_ap.save');
