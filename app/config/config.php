...
$config['base_url'] .= preg_replace(array('@/+$@', "~\\\\~"), '', dirname($_SERVER['SCRIPT_NAME'])).'/';
...
$config['sess_cookie_name']			= env('SESSION_NAME');
...
$config['csrf_token_name'] 		= env('CSRF_TOKEN');
$config['csrf_cookie_name'] 	= env('CSRF_NAME');
$config['csrf_expire'] 			= env('CSRF_LIFETIME');
