...
class ManualApPayment extends BaseController
{
    ...
    public function list () /*{{{*/
    {
        ...
        return view('akunting.hutang_supplier.manual_ap_payment.list', compact(
            'sPeriod',
            'ePeriod',
            'cmb_supp',
            'cmb_doctor'
    ...
    function cetak ($myid) /*{{{*/
    {
        $rsd = ManualApPaymentMdl::detail_trans($myid);
        ...
        return view('akunting.hutang_supplier.manual_ap_payment.cetak', compact(
            'myid',
            'rsd',
            'data_db',
            'nama_dokter',
   ...
   function data_invoice(){
        ...
        $rand            = rand();
        return view('akunting.hutang_supplier.manual_ap_payment.data-invoice', compact(
            'suppid',
            'doctor_id',
            'rand',
        ));
