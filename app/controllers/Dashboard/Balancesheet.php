...
*/
        ...
        $dash_top_3 = array_slice($filtered, 0, 8);
        $dash_lainnya = array_slice($filtered, 8);
        ...
        return view('dashboard.balancesheet', compact(
            'tgl_cetak',
            'data',
            'bln_prev',
            'bln',
            ...
            'total_kewajiban',
            'total_rl_tahun_berjalan',
            'total_rl_tahun_berjalan_sub',
