...
class LevelApproval extends BaseController
{
    public function __construct () /*{{{*/
    {
        parent::__construct();

        $this->load->model('Konfigurasi/PengaturanDasar/LevelApprovalMdl');
    } /*}}}*/
    ...
    public function index () /*{{{*/
    {
        ...
        return view('konfigurasi.pengaturan_dasar.level_approval.index', compact(
            'cmb_group'
        ));
    } /*}}}*/
}
