...
class ManualApAPI extends BaseAPIController
{
    ...
    public function form_get () /*{{{*/
    {
        ...
        $cmb_supp = $data_supplier->GetMenu2('suppid', $data_head->suppid, true, false, 0, 'class="form-select form-select-sm rounded-1 w-100" id="suppid" data-control="select2" data-allow-clear="true" data-placeholder="Pilih Supplier..."');
        ...
        $cmb_coa = $data_coa->GetMenu2('coaid', '', true, false, 0, 'class="form-select form-select-sm rounded-1 w-100" id="coaid" data-control="select2" data-allow-clear="true" data-placeholder="Pilih COA"');
