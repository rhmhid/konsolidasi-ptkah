...
class MutasiSaldoAPI extends BaseAPIController
{
    ...
    public function list_get () /*{{{*/
    {
        ...
        $jmlbris = MutasiSaldoMdl::list($data, true)->RecordCount();
        $rs = MutasiSaldoMdl::list($data, false, $data['start'], $data['length']);
    ...
    public function create_get () /*{{{*/
    {
        ...
        return view('akunting.mutasi_saldo.create', compact(
            'mutasi_date',
            'cmb_bank_from',
            'cmb_bank_to'
        ));
    ...
    {
        $res = floatval(MutasiSaldoMdl::cek_saldo($mybank));
    ...
    {
        $msg = MutasiSaldoMdl::delete_trans($myid);
