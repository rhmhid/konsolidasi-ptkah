...
class AgingHutangUnbillAPI extends BaseAPIController
{
    ...
    public function excel_get () /*{{{*/
    {
        ...
        $sheet->setCellValue('D5', 'Penerimaan Barang');
        $sheet->setCellValue('E5', 'A/P Purchasing Invoice');
        ...
        $row_pos = 6;
        $no = 1;
        $tot_opbal = $tot_grn = $tot_ap_inv = $tot_closbal = 0;
        ...
        while (!$rs->EOF)
        {
            ...
            $sheet->setCellValue('D'.$row_pos, $grn);
            $sheet->setCellValue('E'.$row_pos, $ap_inv);
        ...
        if ($no > 1)
        {
            ...
            $sheet->setCellValue('D'.$row_pos, $tot_grn);
            $sheet->setCellValue('E'.$row_pos, $tot_ap_inv);
    ...
    public function excel_detail_get () /*{{{*/
    {
        ...
        $rs = AgingHutangUnbillMdl::detail($data);
