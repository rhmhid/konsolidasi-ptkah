...
use PhpOffice\PhpSpreadsheet\Style\Border as PiutangKaryawanMdl;
use PhpOffice\PhpSpreadsheet\Style\Alignment;

class PiutangKaryawanAPI extends BaseAPIController
{
    ...
    public function __construct () /*{{{*/
    {
        ...
        $this->load->model('AkuntansiReport/SummaryReport/PiutangKaryawanMdl');
    ...
    public function excel_get () /*{{{*/
    {
        ...
        $rs = PiutangKaryawanMdl::list($data);
        ...
        $style_header = [
            ...
            'borders'	=> [
            	'allBorders'	=> [
            		'borderStyle'	=> PiutangKaryawanMdl::BORDER_THIN
            	]
            ],
            'fill' 		=> [
		...
		$sheet->setCellValue('A1', 'SUMMARY REPORT A/R KARYAWAN');
        ...
        $sheet->setCellValue('D5', 'A/R Karyawan Invoice');
        $sheet->setCellValue('E5', 'A/R Karyawan Payment');
        ...
        $sheet->setTitle("Summary Report AR Karyawan");

        header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
        header('Content-Disposition: attachment; filename="Summary Report AR Karyawan.xlsx"');
    ...
    public function excel_detail_get () /*{{{*/
    {
        ...
        $rs = PiutangKaryawanMdl::detail($data);
		...
		$sheet->setCellValue('A1', 'SUMMARY REPORT A/R KARYAWAN DETAIL');
        $sheet->mergeCells('A1:F1');
        $sheet->getStyle('A1')->getFont()->setSize(16)->setBold(true);
