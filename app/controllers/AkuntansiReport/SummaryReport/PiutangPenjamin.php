...
class PiutangPenjamin extends BaseController
{
    ...
    public function list () /*{{{*/
    {
        ...
        return view('akuntansi_report.summary_report.piutang_penjamin.list', compact(
            'cmb_cabang'
        ));
    } /*}}}*/
    ...
    public function cetak () /*{{{*/
    {
        ...
        return view('akuntansi_report.summary_report.piutang_penjamin.cetak', compact(
            'cabang',
            'data',
            'report_month',
            'rs'
    ...
    public function detail () /*{{{*/
    {
        ...
        return view('akuntansi_report.summary_report.piutang_penjamin.detail', compact(
            'cabang',
            'data',
            'report_month',
            'rs'
