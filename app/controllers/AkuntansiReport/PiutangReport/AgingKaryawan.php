...
class AgingKaryawan extends BaseController
{
    ...
    public function list () /*{{{*/
    {
        ...
        return view('akuntansi_report.piutang_report.aging_karyawan.list', compact(
            'cmb_cabang'
        ));
    } /*}}}*/
    ...
    public function cetak () /*{{{*/
    {
        ...
        return view('akuntansi_report.piutang_report.aging_karyawan.cetak', compact(
            'cabang',
            'data',
            'report_month',
            'rs'
    ...
    public function detail () /*{{{*/
    {
        ...
        return view('akuntansi_report.piutang_report.aging_karyawan.detail', compact(
            'cabang',
            'data',
            'report_month',
            'rs'
