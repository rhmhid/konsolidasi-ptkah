...
class DpSupplierMdl extends DB
{
    ...
    //     $sql = "UPDATE jurnal_manual SET is_posted = 't', modify_by = $pid, modify_time = NOW() WHERE jmid = ?";
    ...
    //     $sql = "UPDATE jurnal_manual SET is_posted = 'f' WHERE jmid = ?";
    //     $ok = DB::Execute($sql, array($myid));

    //     $sql = "DELETE FROM jurnal_manual_d WHERE jmid = ?";
    //     if ($ok) $ok = DB::Execute($sql, array($myid));

    //     $sql = "DELETE FROM jurnal_manual WHERE jmid = ?";
    //     if ($ok) $ok = DB::Execute($sql, array($myid));
