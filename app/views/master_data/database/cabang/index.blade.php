    ...
    <div class="flex-lg-row-fluid">
        ...
        <div class="card border border-gray-300 rounded-1">
            ...
            <div class="card-body p-0" id="kt_content_header">
                ...
                <form method="post" id="form-branch" novalidate="">
                    <!--begin::Compact form-->
                    <div class="p-6 pb-0">
            ...
            <div class="card-body p-6 mt-n2 border-top-3 border-dark" id="kt_content_body">
                <table id="myTableBranch" class="table table-striped table-row-bordered border border-bottom border-gray-300 align-middle rounded-0 g-4 fs-8 w-100">
...
<script type="text/javascript">
    ...
    $('#myTableBranch').on('click', '.branch-update', function (e)
    {
