...
<div class="modal-body py-6 px-lg-7">
    <div class="scroll-y me-n7 pe-7" id="kt_modal_new_address_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_new_address_header" data-kt-scroll-wrappers="#kt_modal_new_address_scroll" data-kt-scroll-offset="300px">
        <form method="post" id="form-input-db" novalidate>
            <!--begin::Compact form-->
...
<script type="text/javascript">
    ...
    $('#sCari-Barang').select2({
        dropdownParent      : $('#mdl-form-db'),
        placeholder         : '-- Pilih barang',
        minimumInputLength  : 3,
        ajax                :
                            {
                                url             : "{{ route('api.inventori.distribusi_barang.cari_barang') }}",
    ...
    }).on('select2:select', function (e)
    {
        ...
        if (items.id != '')
        {
            ...
            AddBarang(items.id, items.text, items.kode_brg, items.nama_brg, items.kode_satuan, items.all_satuan, items.stock_from, items.stock_to)
    ...
    function CheckGudang ()
    {
        ...
        if (gid == reff_gid)
        {
            swalShowMessage('Information, ', 'Gudang Penerima Tidak Boleh Sama Dengan Gudang Pengirim !', 'warning')
    ...
    function AddBarang (mbid, barang, kode_brg, nama_brg, kode_satuan, all_satuan, stock_from = 0, stock_to = 0)
    {
        ...
        let data_coa = `<tr class="align-middle">
                            ...
                            <td class="text-center">
                                <font id="lbl-stock-to-${mbid}">${stock_to} ${kode_satuan}</font>
                                <input type="hidden" name="stock_to[]" id="stock-to-${mbid}" value="${stock_to}" />
                            </td>
                            <td class="text-center">
    ...
    }).on('select2:select', '.data-satuan', function (e)
    {
        ...
        let konversi_to = (parseFloat(isi_kecil_pre) * parseFloat($(stock_to).val())) / parseFloat(isi_kecil)

        $(stock_to).val(konversi_to)
        $('#lbl-stock-to-' + mbid).text(konversi_to + ' ' + satuan)
    })
    ...
    $('#form-input-db').submit(function (e)
    {
        ...
        if (validasiForm(this))
        {
            ...
            formSubmitUrl = "{{ route('api.inventori.distribusi_barang.save') }}"
