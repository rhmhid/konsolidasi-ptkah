    ...
    <div class="flex-lg-row-fluid">
        ...
        <div class="card border border-gray-300 rounded-1">
            ...
            <div class="card-body p-0" id="kt_content_header">
                ...
                <form method="post" id="form-kartu-stock" novalidate="">
                    <!--begin::Compact form-->
                    <div class="p-6 pb-0">
...
<script type="text/javascript">
    ...
    $('#btnCetak').click(function (e)
    {
        ...
        if ($sGid == '')
        {
            swalShowMessage('Perhatian!', "Gudang Harus Dipilih.", 'warning')
        ...
        let $link = "{{ route('inventori_report.kartu_stok.cetak') }}"
    ...
    $('#form-kartu-stock').submit(function (e)
    {
        e.preventDefault() // batalkan aksi form submit
        ...
        if (validasiForm(this))
        {
            ...
            setTimeout((function ()
            {
                const href = "{{ route('api.inventori_report.kartu_stok.excel') }}"
                const name = 'Kartu Stok - ' + moment().format('DD-MM-YYYY') + '.xlsx'
