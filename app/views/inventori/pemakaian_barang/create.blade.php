        ...
        <form method="post" id="form-input-pb" novalidate>
            ...
            <div class="row g-0 gx-4 mt-3">
                ...
                <div class="col-lg-4">
                    <label class="text-dark fw-bold fs-7 pb-2">
                        Cabang
                        <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Jika Transfer Antar Cabang, Harap Pilih Cabang Sehingga C.O.A Cost Otomatis Tersetting Sesuai Konfirgurasi Cabang"></i>
                    </label>
                    {!! $cmb_branch !!}
                </div>
...
<script type="text/javascript">
    ...
    $('#to-bid').on('change', function (e)
    {
        let coaid = $(this).find('option:selected').data('coaid')

        $('#coaid-cogs').val(coaid).trigger('change')
    })
