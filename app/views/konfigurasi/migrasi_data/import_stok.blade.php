        ...
        <div class="card rounded-1 border border-gray-300">
            ...
            <div class="card-body p-0" id="kt_content_header">
                ...
                <div class="border-bottom border-gray-300">
                    <form method="post" id="form-import-stok" enctype="multipart/form-data" novalidate="">
                        <!--begin::Compact form-->
                        <div class="p-6 pb-0">
                            <div class="row g-0 gx-4">
                                ...
                                <div class="col-lg-6 pt-2">
                                    ...
                                    <input type="text" name="keterangan" id="keterangan" value="" class="form-control form-control-sm rounded-1" required="" />
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    $('#form-import-stok').submit(function (e)
    {
...
//        const coaid = $('#coaid').val();
        const gid = $('#gid').val();

  /*      if (coaid == '')
            return swalShowMessage('Warning!', "C.O.A Belum di Pilih", 'warning')
*/
        if (gid == '')
            return swalShowMessage('Warning!', "Gudang Belum di Pilih", 'warning')
        ...
        let formSubmitUrl = "{{ route('api.migrasi_data.import_stok.save') }}"
