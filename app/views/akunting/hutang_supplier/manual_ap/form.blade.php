        ...
        <form method="post" id="fi-map" novalidate>
            ...
            <div class="row g-0 gx-4 mt-3">
                ...
                <div class="col-lg-3">
                    ...
                    <div class="input-group">
                        <input type="text" name="tgl_faktur_pajak" id="tgl_faktur_pajak" value="{{ $data_head->tgl_faktur_pajak }}" class="form-control form-control-sm rounded-1 mydate" readonly="" required="" />
                        <span class="input-group-text">
                            <i class="fas fa-calendar-alt"></i>
                        </span>
                    </div>
            ...
            <div class="row g-0 gx-4 mt-3 div-doctor">
                <div class="col-lg-4">
...
<script type="text/javascript">
    ...
    function AddCoa (coaid = 0, notes = '', amount = 0, madid = 0,pccid='')
    {
        ...
        let cmb_cost = `<select name="pccid[]" id="pccid-${madid}" data-madid="${madid}" class="form-select form-select-sm rounded-1 w-100" data-control="select2">`
    ...
    $('#fi-map').submit(function (e)
    {
        ...
        if (validasiForm(this))
        {
            ...
            formSubmitUrl = "{{ route('api.akunting.hutang_supplier.manual_ap.save') }}"
