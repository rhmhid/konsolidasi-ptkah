...
<div class="modal-body py-6 px-lg-7">
    <div class="scroll-y me-n7 pe-7" id="kt_modal_new_address_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_new_address_header" data-kt-scroll-wrappers="#kt_modal_new_address_scroll" data-kt-scroll-offset="300px">
        <form method="post" id="form-input-dps" novalidate>
            <input type="text" name="dsid" id="dsid" value="{{ $data_db->dsid }}" />
            ...
            <div class="row g-0 gx-4">
                <div class="col-lg-3">
                    ...
                    <div class="input-group input-group-sm">
                        <input type="text" name="dpdate" id="dpdate" value="{{ $data_db->dpdate }}" class="form-control form-control-sm rounded-1 mydate-time" required="" />
            ...
            <div class="row g-0 gx-4 mt-3">
                <div class="col-lg-3">
                    ...
                    <input type="text" class="form-control form-control-sm rounded-1" name="no_inv" id="no_inv" value="{{ $data_db->no_inv }}" required="" />
                </div>

                <div class="col-lg-3">
                    <label class="text-dark fw-bold fs-7 pb-2">Tanggal Faktur Pajak</label>
                    <div class="input-group input-group-sm">
                        <input type="text" name="tgl_faktur_pajak" id="tgl_faktur_pajak" value="{{ $data_db->tgl_faktur_pajak }}" class="form-control form-control-sm rounded-1 mydate-time" required="" />
                        <span class="input-group-text">
                            <i class="las la-calendar-alt fs-1"></i>
                        </span>
                    </div>
                ...
                <div class="col-lg-3">
                    ...
                    <input type="text" class="form-control form-control-sm rounded-1" name="faktur_pajak" id="faktur_pajak" value="{{ $data_db->faktur_pajak }}" required="" />
                </div>

                <div class="col-lg-3">
                    <label class="text-dark fw-bold fs-7 pb-2">No. Referensi</label>
                    <input type="text" class="form-control form-control-sm rounded-1" name="no_referensi" id="no_referensi" value="{{ $data_db->no_referensi }}" required="" />
                </div>
                ...
                <div class="col-lg-3">
                    <label class="text-dark fw-bold fs-7 pb-2">Total</label>
                    <div class="input-group input-group-sm">
                        <span class="input-group-text">Rp.</span>
                        <input type="text" class="form-control form-control-sm w-50px fs-8 rounded-1 currency" name="tot_amount" id="tot_amount" readonly="" />
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    $('#form-input-dps').submit(function (e)
    {
