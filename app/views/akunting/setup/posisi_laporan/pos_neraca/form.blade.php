...
<div class="modal-body py-6 px-lg-7">
    <div class="scroll-y me-n7 pe-7" id="kt_modal_new_address_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_new_address_header" data-kt-scroll-wrappers="#kt_modal_new_address_scroll" data-kt-scroll-offset="300px">
        <form method="post" id="form-input-pos-na" novalidate>
            <input type="hidden" name="pnid" id="pnid" value="{{ $data_pos->pnid }}" />
            ...
            <div class="row g-0 gx-4 mb-5">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="form-check form-switch form-check-custom form-check-solid">
                        <input class="form-check-input" name="sum_total" type="checkbox" id="sum_total" value="t" {{ $chk_sum_total }} />
...
<script type="text/javascript">
    $('.modal .form-select').select2({
        width: '100%',
        dropdownParent: $('#popup-form-pos-na')
    })
    ...
    $('#form-input-pos-na').submit(function (e)
    {
        ...
        if (validasiForm(this))
        {
            ...
            formSubmitUrl = "{{ route('api.akunting.setup.posisi_laporan.pos_neraca.save') }}"
