...
<div class="modal-body py-6 px-lg-7">
    <div class="scroll-y me-n7 pe-7" id="kt_modal_new_address_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_new_address_header" data-kt-scroll-wrappers="#kt_modal_new_address_scroll" data-kt-scroll-offset="300px">
        <form method="post" id="form-input-default-coa" novalidate>
            <input type="hidden" name="dcid" id="dcid" value="{{ $data_def->dcid }}" />

            <!--begin::Compact form-->
            <div class="row g-0 gx-4 mb-5">
                <div class="col-lg-6">
                    <label class="text-dark fw-bold fs-7 pb-2 required">Default Code</label>
                    <input type="text" name="default_code" id="default_code" value="{{ $data_def->default_code }}" class="form-control form-control-sm rounded-1 w-100" required="" readonly="" />
                </div>

                <div class="col-lg-6">
                    <label class="text-dark fw-bold fs-7 pb-2 required">Default Description</label>
                    <input type="text" name="default_desc" id="default_desc" value="{{ $data_def->default_desc }}" class="form-control form-control-sm rounded-1 w-100" required="" readonly="" />
                </div>
            </div>
...
<script type="text/javascript">
    $('.modal .form-select').select2({
        width: '100%',
        dropdownParent: $('#popup_form_default_coa')
    })

    // aksi submit edit / update
    $('#form-input-default-coa').submit(function (e)
    {
        ...
        if (validasiForm(this))
        {
            ...
            formSubmitUrl = "{{ route('api.akunting.setup.master_coa.default_coa.update') }}"
                ...
                .done( data => {
                    ...
                    if (data.success)
                    {
                        ...
                        .then((result) =>
                        {
                            ...
                            {
                                $("#popup_form_default_coa").modal('hide')
