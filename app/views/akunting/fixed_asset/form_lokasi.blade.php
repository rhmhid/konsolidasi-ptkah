...
<div class="modal-body py-6 px-lg-7">
    <div class="scroll-y me-n7 pe-7" id="kt_modal_new_address_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_new_address_header" data-kt-scroll-wrappers="#kt_modal_new_address_scroll" data-kt-scroll-offset="300px">
        <form method="post" id="form-input-lokasi" novalidate>
            <input type="hidden" name="falid" id="falid" value="{{ $data_lok->falid }}" />
            ...
            <div class="row g-0 gx-4">
                <div class="col-lg-6">
                    <div class="row mb-3">
                        <div class="col-lg-8">
                            <label class="text-dark fw-bold fs-7 pb-2 required">Kode Lokasi</label>
                            <input type="text" name="lokasi_kode" id="lokasi_kode" value="{{ $data_lok->lokasi_kode }}" class="form-control form-control-sm rounded-1 w-100" required="" readonly="" />
                        ...
                        <div class="col-lg-4">
                            <label class="form-label form-label-sm text-dark">Status Lokasi</label>
                    ...
                    <div class="mb-3">
                        <label class="text-dark fw-bold fs-7 pb-2 required">Nama Lokasi</label>
                        <input type="text" name="lokasi_nama" id="lokasi_nama" value="{{ $data_lok->lokasi_nama }}" class="form-control form-control-sm rounded-1 w-100" required="" />
                        <div class="invalid-feedback">
                            <i class="fas fa-exclamation-circle text-danger"></i>
                            Harap diisi
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="d-flex flex-column h-100">
                        ...
                        <textarea id="keterangan" name="keterangan" class="form-control form-control-sm rounded-1 flex-grow-1 py-md-0">{{ $data_lok->keterangan }}</textarea>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
        ...
        Swal.fire({
            ...
            preConfirm: async (lokasi_kode) => {
                try {
                    ...
                    let link = "{{ route('api.akunting.fixed_asset.cek_kode', ['mytype' => 'lokasi', 'kode' => ':lokasi_kode']) }}"
                        link = link.replace(':lokasi_kode', lokasi_kode)
    ...
    $('#form-input-lokasi').submit(function (e)
    {
        ...
        if (checkRequired(this))
        {
            ...
            formSubmitUrl = "{{ route('api.akunting.fixed_asset.lokasi.save') }}"
