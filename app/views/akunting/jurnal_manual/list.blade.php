    ...
    <div class="flex-lg-row-fluid">
        ...
        <div class="card border border-gray-300 rounded-1">
            ...
            <div class="card-body p-0" id="kt_content_header">
                    ...
                    <div class="d-flex align-items-center">
                        <div class="d-flex flex-column flex-grow-1">
                            <h2 class="pt-2 text-dark">
                                ...
                                Daftar Jurnal Manual
                            </h2>
                        </div>

                        <a class="btn btn-sm rounded-1 btn-light-dark jm-add" data-jmid="0" href="javascript:void(0)">
                ...
                <form method="post" id="form-jurnal-manual" novalidate="">
                    <!--begin::Compact form-->
                    <div class="p-6 pb-0">
            ...
            <div class="card-body p-6 mt-n2 border-top-3 border-dark" id="kt_content_body">
                <table id="myTableJurnalManual" class="table table-striped table-row-bordered border border-bottom border-gray-300 align-middle rounded-0 g-4 fs-8 w-100">
...
<!--begin::Modal - Ubah-->
<div class="modal fade" id="mdl-form-jm" data-bs-focus="false" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="mdl-form-jm" aria-hidden="true">
    <!--begin::Modal dialog-->
...
<div class="modal fade" id="mdl-form-jm-upload" data-bs-focus="false" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="mdl-form-jm-upload" aria-hidden="true">
    <!--begin::Modal dialog-->
...
<script type="text/javascript">
                    ...
                    },
                    {
                        ...
                        render: function (data, type, row, meta)
                        {
                            if (row.is_posted == 't')
                                ...
                                $btnFungsi = `<a href="javascript:void(0)" data-jmid="${row.jmid}" title="Posting Jurnal" class="btn btn-info btn-sm btn-icon fs-8 jm-posted">
                                                <i class="las la-check-circle"></i>
                                            </a>`

                            $btnFungsi += `&nbsp;<a href="javascript:void(0)" data-jmid="${row.jmid}" title="Hapus" class="btn btn-danger btn-sm btn-icon fs-8 jm-hapus">
    ...
    // aksi submit cari
    $('#form-jurnal-manual').submit(function (e)
    {
    ...
    $('.jm-add').on('click', function (e)
    {
        showLoading()

        let getForm = async function getForm ()
                    {
                        let result
                        let link = "{{ route('api.akunting.jurnal_manual.create') }}"
        ...
        getForm().then((res) => {
            ...
            // Show modal
            openModal('mdl-form-jm', res, null, true)
        })
    })

    $('#myTableJurnalManual').on('click', '.jm-detail', function ()
    {
    ...
    $('#myTableJurnalManual').on('click', '.jm-posted', function ()
    {
    ...
    $('#myTableJurnalManual').on('click', '.jm-hapus', function ()
    {
        const jmid = $(this).data('jmid')
