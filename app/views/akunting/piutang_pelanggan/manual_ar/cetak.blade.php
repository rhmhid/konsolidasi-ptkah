...
<h2 class="bdr">
    <span class="rgt">
        <span class="til">No. A/R</span><span class="num">{{ $data_db->arcode }}</span>
    </span>

    INVOICE PENGAJUAN PENERIMAAN KAS / BANK
    <span>Tanggal : {{ dbtstamp2stringlong_ina($data_db->ardate) }}</span>
</h2>
