    ...
    <div class="flex-lg-row-fluid">
        ...
        <div class="card border border-gray-300 rounded-1">
            ...
            <div class="card-body p-0" id="kt_content_header">
                ...
                <form method="post" id="form-kartu-hutang" novalidate="">
                    <!--begin::Compact form-->
                    <div class="p-6 pb-0">
...
<script type="text/javascript">
    ...
    $('#btnCetak').click(function (e)
    {
        ...
        if ($suppid == '')
        {
            swalShowMessage('Perhatian!', "Supplier Harus Dipilih.", 'warning')

            return false
        }

        if ($suppid == -1 && $doctorId == '')
        {
            swalShowMessage('Perhatian!', "Dokter Harus Dipilih.", 'warning')
        ...
        let $link = "{{ route('hutang_report.kartu_hutang.cetak') }}"
    ...
    $('#form-kartu-hutang').submit(function (e)
    {
        e.preventDefault() // batalkan aksi form submit
        ...
        if (validasiForm(this))
        {
            ...
            setTimeout((function ()
            {
                const href = "{{ route('api.hutang_report.kartu_hutang.excel') }}"
                const name = 'Laporan Kartu Hutang - ' + moment().format('DD-MM-YYYY') + '.xlsx'
