                    ...
                    <div class="d-flex align-items-center">
                        <div class="d-flex flex-column flex-grow-1">
                            <h2 class="pt-2 text-dark">
                                ...
                                Summary A/R Karyawan
                            </h2>
                        </div>
                    </div>
                </div>

                <form method="post" id="form-sak" novalidate="">
                    <!--begin::Compact form-->
                    <div class="p-6 pb-0">
...
<script type="text/javascript">
    ...
    $('#btnCetak').click(function (e)
    {
        ...
        let $link = "{{ route('summary_report.ar_emp.cetak') }}"
    ...
    $('#form-sak').submit(function (e)
    {
        ...
        if (validasiForm(this))
        {
            ...
            {
                const $form = $('#form-sak')
                const name = 'Summary Report AR Company - ' + moment().format('DD-MM-YYYY') + '.xlsx'

                let href = "{{ route('api.summary_report.ar_emp.excel') }}"
