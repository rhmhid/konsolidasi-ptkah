...
<script type="text/javascript">
    ...
    function ExportExcel ()
    {
        setTimeout((function ()
        {
            const name = 'Summary Report AR Karyawan Detail - ' + moment().format('DD-MM-YYYY') + '.xlsx'

            let href = "{{ route('api.summary_report.ar_emp.detail.excel') }}"
...
@section('content')
<h2 class="bdr">
    Summary Report A/R Karyawan ( Detail )
