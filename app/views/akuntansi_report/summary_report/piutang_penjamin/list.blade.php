    ...
    <div class="flex-lg-row-fluid">
        ...
        <div class="card border border-gray-300 rounded-1">
            ...
            <div class="card-body p-0" id="kt_content_header">
                ...
                <form method="post" id="form-sac" novalidate="">
                    <!--begin::Compact form-->
                    <div class="p-6 pb-0">
...
<script type="text/javascript">
    ...
    $('#btnCetak').click(function (e)
    {
        ...
        let $link = "{{ route('summary_report.ar_company.cetak') }}"
    ...
    $('#form-sac').submit(function (e)
    {
        ...
        if (validasiForm(this))
        {
            ...
            setTimeout((function ()
            {
                ...
                let href = "{{ route('api.summary_report.ar_company.excel') }}"
