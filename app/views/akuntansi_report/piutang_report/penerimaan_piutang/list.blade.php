    ...
    <div class="flex-lg-row-fluid">
        ...
        <div class="card border border-gray-300 rounded-1">
            ...
            <div class="card-body p-0" id="kt_content_header">
                ...
                <form method="post" id="form-pp" novalidate="">
                    <!--begin::Compact form-->
                    <div class="p-6 pb-0">
...
<script type="text/javascript">
    ...
    $('#btnCetak').click(function (e)
    {
        ...
        let $link = "{{ route('piutang_report.penerimaan_piutang.cetak') }}"
    ...
    $('#form-pp').submit(function (e)
    {
        ...
        if (validasiForm(this))
        {
            ...
            setTimeout((function ()
            {
                const href = "{{ route('api.piutang_report.penerimaan_piutang.excel') }}"
