                    ...
                    <div class="d-flex align-items-center">
                        <div class="d-flex flex-column flex-grow-1">
                            <h2 class="pt-2 text-dark">
                                ...
                                Laporan Aging Piutang Karyawan
                            </h2>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    $('#btnCetak').click(function (e)
    {
        ...
        let $link = "{{ route('piutang_report.aging_karyawan.cetak') }}"
    ...
    $('#form-aging-piutang').submit(function (e)
    {
        ...
        if (validasiForm(this))
        {
            ...
            setTimeout((function ()
            {
                const href = "{{ route('api.piutang_report.aging_karyawan.excel') }}"
                const name = 'Laporan Aging Piutang Karyawan - ' + moment().format('DD-MM-YYYY') + '.xlsx'
