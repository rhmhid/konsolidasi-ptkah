...
<script type="text/javascript">
    ...
    function ExportExcel ()
    {
        setTimeout((function ()
        {
            const name = 'Laporan Aging Piutang Karyawan Detail - ' + moment().format('DD-MM-YYYY') + '.xlsx'

            let href = "{{ route('api.piutang_report.aging_karyawan.detail.excel') }}"
...
@section('content')
<h2 class="bdr">
    Laporan Aging Piutang Karyawan Detail
...
<table width="100%" class="bdr2 pad">
    ...
    <tbody>
        ...
        @forelse ($rs as $row)
            ...
            @if ($is_new_karyawan)
                <tr>
                    <td colspan="5" align="right"><b>SUBTOTAL {{ $current_karyawan }}</b></td>
