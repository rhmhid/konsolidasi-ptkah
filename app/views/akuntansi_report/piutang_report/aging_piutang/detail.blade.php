...
<script type="text/javascript">
    ...
    function ExportExcel ()
    {
        setTimeout((function ()
        {
            const name = 'Laporan Aging Piutang Detail - ' + moment().format('DD-MM-YYYY') + '.xlsx'

            let href = "{{ route('api.piutang_report.aging_piutang.detail.excel') }}"
...
<table width="100%" class="bdr2 pad">
    ...
    <tbody>
        ...
        @forelse ($rs as $row)
            ...
            @if ($is_new_customer)
                <tr>
                    <td colspan="5" align="right"><b>SUBTOTAL {{ $current_customer }}</b></td>
