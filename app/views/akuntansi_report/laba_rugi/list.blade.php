    ...
    <div class="flex-lg-row-fluid">
        ...
        <div class="card border border-gray-300 rounded-1">
            ...
            <div class="card-body p-0" id="kt_content_header">
                ...
                <form method="post" id="form-pl" novalidate="">
                    <!--begin::Compact form-->
                    <div class="p-6 pb-0">
                        <div class="row g-0 gx-4 mb-5">
                            <div class="col-lg-3">
                                ...
                                <select class="form-select form-select-sm rounded-1 w-100" id="s-Tipe" data-control="select2" required="">
                                    <option value="pl-std" selected="">Laba Rugi Standard</option>
                                    <option value="pl-new">Laba Rugi ( Format Baru )</option>
                                    <option value="pl-new-detail">Laba Rugi Detail ( Format Baru )</option>
                                    <option value="pl-new-daily">Laba Rugi Daily ( Format Baru )</option>
                                    <option value="pl-new-detail-daily">Laba Rugi Daily Detail ( Format Baru )</option>
                                </select>
                            </div>
...
<script type="text/javascript">
    ...
    $('#s-Tipe').change(function ()
    {
        ...
        if (tipe == 'pl-new-daily' || tipe == 'pl-new-detail-daily')
        {
    ...
    $('#btnCetak').click(function (e)
    {
        ...
        if ($sTipe == 'pl-new-daily' || $sTipe == 'pl-new-detail-daily')
        {
            if ($sDatePeriod == '')
            {
        ...
        let $link = "{{ route('akuntansi_report.laba_rugi.cetak', ['mytipe' => ':mytipe']) }}"
    ...
    $('#form-pl').submit(function (e)
    {
        ...
        if (validasiForm(this))
        {
            ...
            setTimeout((function ()
            {
                ...
                let href = "{{ route('api.akuntansi_report.laba_rugi.excel', ['mytipe' => ':mytipe']) }}"
