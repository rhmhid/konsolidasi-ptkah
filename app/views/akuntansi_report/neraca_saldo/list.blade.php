                    ...
                    <div class="d-flex align-items-center">
                        <div class="d-flex flex-column flex-grow-1">
                            <h2 class="pt-2 text-dark">
                                ...
                                Form Neraca Saldo ( Trial Balance )
                            </h2>
                        </div>
                    </div>
                </div>

                <form method="post" id="form-tb" novalidate="">
                    <!--begin::Compact form-->
                    <div class="p-6 pb-0">
...
<script type="text/javascript">
    ...
    $('#btnCetak').click(function (e)
    {
        ...
        let $link = "{{ route('akuntansi_report.neraca_saldo.cetak') }}"
    ...
    $('#form-tb').submit(function (e)
    {
        ...
        if (validasiForm(this))
        {
            ...
            setTimeout((function ()
            {
                const href = "{{ route('api.akuntansi_report.neraca_saldo.excel') }}"
                const name = 'Neraca Saldo - ' + moment().format('DD-MM-YYYY') + '.xlsx'
